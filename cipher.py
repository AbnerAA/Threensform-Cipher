...
def feistel(block, external_key, cipher_function, iters=16, mode=1, encrypt=True):
...
def block_cipher(text, external_key, cipher_function, block_length=12, iters=16, mode=1, encrypt=True):
